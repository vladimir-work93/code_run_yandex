# 8. Стильная одежда (легкая)
#
# Глеб обожает шоппинг. Как-то раз он загорелся идеей
# подобрать себе майку и штаны так,
# чтобы выглядеть в них максимально стильно.
# В понимании Глеба стильность одежды тем больше,
# чем меньше разница в цвете элементов его одежды.
#
# В наличии имеется N (1≤N≤ 100000) маек и M (1≤M≤ 10 000 000) штанов,
# про каждый элемент известен его цвет
# (целое число от 1 до 10 000 000).

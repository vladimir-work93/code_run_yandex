...
# дающий право на один бесплатный обед (при покупке на сумму 100 рублей и
...
# Однако стипендия у Пети небольшая, и поэтому он хочет по максимуму
# использовать предоставляемую систему скидок так, чтобы его суммарные
# затраты были минимальны. Требуется найти минимально возможную
# суммарную стоимость обедов и номера дней, в которые Пете следует
...
# стоимость обедов. Во второй строке выдайте два числа
# K1 и K2 — количество купонов, которые останутся
# неиспользованными у Пети после этих N дней и
# количество использованных им купонов соответственно.
#
# В последующих K2 строках выдайте в возрастающем порядке
# номера дней, когда Пете следует воспользоваться купонами.
# Если существует несколько решений с минимальной суммарной
# стоимостью, то выдайте то из них, в котором значение K1 максимально
